        ...
        <Layout title="Home">
            <Container className="Home">
                ...
                <div className="Container">
                    ...
                    <li>
                        TOEIC 100 - 300 điểm: Trình độ cơ bản. Khả năng giao
                        tiếp tiếng Anh kém.
                    </li>
                    <li>
                        TOEIC 300 - 450 điểm: Có khả năng hiểu & giao tiếp tiếng
                        Anh mức độ trung bình. Là yêu cầu đối với học viên tốt
                        nghiệp các trường nghề, cử nhân các trường Cao đẳng (hệ
                        đào tạo 3 năm).
                    </li>
                    <li>
                        TOEIC 450 - 650 điểm: Có khả năng giao tiếp tiếng Anh
                        khá. Là yêu cầu chung đối với SV tốt nghiệp Đại học hệ
                        đào tạo 4-5 năm; nhân viên, trưởng nhóm tại các doanh
                        nghiệp có yếu tố nước ngoài.
                    </li>
                    <li>
                        TOEIC 650 - 850 điểm: Có khả năng giao tiếp tiếng Anh
                        tốt. Là yêu cầu đối với cấp trưởng phòng, quản lý điều
                        hành cao cấp, giám đốc trong môi trường làm việc quốc
                        tế.
                    </li>
                    <li>
                        TOEIC 850 - 990 điểm: Có khả năng giao tiếp tiếng Anh
                        rất tốt. Sử dụng gần như người bản ngữ dù tiếng Anh
